...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p afb02f85-88dd-4327-8e80-2bfb6a68c93f
```

> `afb02f85-88dd-4327-8e80-2bfb6a68c93f` is the password of the certificate, you can change it to any password you want.
